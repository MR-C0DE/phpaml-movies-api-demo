...
final class MovieController
{
    ...
    {
        $this->movies = new MovieRepository($connection->pdo());
    }
    ...
    public function index(Request $request): Response
    {
        ...
        $result = $this->movies->search(
            ...
            trim((string) $request->query('genre', '')),
            $page,
            $perPage,
        );
    ...
    public function show(Request $request): Response
    {
        ...
        return $movie === null
            ? $this->json(['error' => ['code' => 'MOVIE_NOT_FOUND', 'message' => 'Movie not found.']], 404)
            : $this->json(['data' => $movie]);
    }

    public function genres(): Response
    {
        return $this->json(['data' => $this->movies->genres()]);
    }
